...
{
    protected string $errorCode = 'HTTP_ERROR';
    ...
    public function getStatusText(): string
    {
        ...
        return self::STATUS_TEXTS[$this->httpStatusCode] ?? 'Unknown';
    }

    /**
     * Get full HTTP status line
     *
     * @return string
     */
    public function getStatusLine(): string
    {
        ...
        return sprintf('%s %d %s', $protocol, $this->httpStatusCode, $this->getStatusText());
    }
}