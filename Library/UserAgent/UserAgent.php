<?php namespace Kodhe\Library\UserAgent;
...
class UserAgent {
	...
	{
		if (($found = file_exists(resolve_path(APPPATH,'config').'/user_agents.php')))
		{
			include(resolve_path(APPPATH,'config').'/user_agents.php');
		}

		if (file_exists(resolve_path(APPPATH,'config').'/'.ENVIRONMENT.'/user_agents.php'))
		{
			include(resolve_path(APPPATH,'config').'/'.ENVIRONMENT.'/user_agents.php');
			$found = TRUE;
		}
